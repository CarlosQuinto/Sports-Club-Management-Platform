...
export const KPICard: React.FC<{
  ...
  icon?: React.ReactNode;
}> = ({ label, value, sublabel, accent = "navy", icon }) => {
  ...
  return (
    <div
      style={{
        ...
        borderRadius: RADIUS.md,
        marginBottom: "1rem",
        border: `1px solid ${C.blueAccent}30`,
    ...
    >
      ...
      >
        ...
        >
          {expanded ? (
            <ChevronUp size={14} color={C.blueAccent} />
          ) : (
            <ChevronDown size={14} color={C.blueAccent} />
          )}
        </div>
      </div>
      {expanded && (
        <div
          style={{
            marginTop: "0.75rem",
            paddingTop: "0.75rem",
            borderTop: `1px solid ${C.blueAccent}20`,
